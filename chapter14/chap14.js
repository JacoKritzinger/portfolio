...
function placeOrder() {
    ...
    // create the output
    var theOutput = "<p>Thank you for your order ,we hope to see you in the near future.</p>";
...
function calculatePrice(numPizzas, typePizza) {
    ...
    if ((typePizza === "supreme") || (typePizza === "meaty maddness")) {
...
function calculateDelivery(orderPrice, deliveryCity, birthday) {
    ...
    if (((deliveryCity === "Pretoria") && (orderPrice > 150)) || (birthday === "yes")) {
        deliveryPrice = 0;
    } else {
        deliveryPrice = 50;
    }
